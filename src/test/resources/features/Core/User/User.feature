...
Feature: User
  ...
  Scenario: Create user without being logged in
    When user hit create user endpoint with email "qa.adm@mailinator.com", name "Admin Admin", role "ADMIN", address "Address", phone "0815123123123", avatar "no-avatar", batch code "", university ""
  ...
  Scenario: Create user with role mentor after logging in as mentor
    When user do login with email "admin@admin.com" and password "administratorfunctionapp"
    And user hit create user endpoint with email "qa.mentor.1@mailinator.com", name "Mentor", role "MENTOR", address "Address", phone "0815123123123", avatar "no-avatar", batch code "", university ""
    And user hit logout endpoint
    And user prepare user request
    And user do login with email "qa.mentor.1@mailinator.com" and password "mentorfunctionapp"
    And user hit create user endpoint with email "qa.mentor.2@mailinator.com", name "Mentor", role "MENTOR", address "Address", phone "0815123123123", avatar "no-avatar", batch code "", university ""
  ...
  Scenario: Create user with role student after logging in as admin with empty batch and university
    When user do login with email "admin@admin.com" and password "administratorfunctionapp"
    And user hit create batch endpoint with name "Batch Name for User Automation" and code "BatchUserAutomation"
    And user hit create user endpoint with email "qa.student@mailinator.com", name "Student First", role "STUDENT", address "Address", phone "0815123123123", avatar "no-avatar", batch code "", university ""
    Then user response code should be 400
    And user error response has key "role" and value "OnlyStudentCanHaveBatchAndUniversity"
  ...
  Scenario: Create user with role student after logging in as admin with non-existent batch
    When user do login with email "admin@admin.com" and password "administratorfunctionapp"
    And user hit create user endpoint with email "qa.student@mailinator.com", name "Student First", role "STUDENT", address "Address", phone "0815123123123", avatar "no-avatar", batch code "BatchUserAutomation", university "University"
    Then user response code should be 400
  ...
  Scenario: Get user without being logged in as admin
    When user do login with email "admin@admin.com" and password "administratorfunctionapp"
    And user hit create user endpoint with email "qa.judge@mailinator.com", name "Judge", role "JUDGE", address "Address", phone "0815123123123", avatar "no-avatar", batch code "", university ""
    And user hit logout endpoint
    And user prepare user request
  ...
  Scenario: Get user after logging in as admin
    When user do login with email "admin@admin.com" and password "administratorfunctionapp"
    And user hit create user endpoint with email "qa.mentor@mailinator.com", name "Mentor", role "MENTOR", address "Address", phone "0815123123123", avatar "no-avatar", batch code "", university ""
    And user hit get user detail endpoint with recorded id
  ...
  Scenario: Get users without being logged in as admin
    ...
    And user hit create user endpoint with email "qa.judge.2@mailinator.com", name "Judge", role "JUDGE", address "Address", phone "0815123123123", avatar "no-avatar", batch code "", university ""
    And user hit logout endpoint
    And user prepare user request
  ...
  Scenario: Update user without being logged in
    ...
    And user hit logout endpoint
    And user prepare user request
    And user hit update user endpoint with email "qa.mentor.update@mailinator.com", name "Mentor Update", role "MENTOR", address "Address Update", phone "0815321321321", avatar "no-avatar", batch code "", university ""
    Then user response code should be 401
  ...
  Scenario: Update user without being logged in as admin
    ...
    And user prepare user request
    And user do login with email "qa.mentor.1@mailinator.com" and password "mentorfunctionapp"
    And user hit update user endpoint with email "qa.mentor.2.update@mailinator.com", name "Mentor Update", role "MENTOR", address "Address Update", phone "0815321321321", avatar "no-avatar", batch code "", university ""
    Then user response code should be 403
  ...
  Scenario: Delete user without being logged in
    When user do login with email "admin@admin.com" and password "administratorfunctionapp"
    And user hit create user endpoint with email "qa.adm.2@mailinator.com", name "Admin", role "ADMIN", address "Address", phone "0815123123123", avatar "no-avatar", batch code "", university ""
  ...
  Scenario: Delete user without being logged in as admin
    When user do login with email "admin@admin.com" and password "administratorfunctionapp"
    And user hit create user endpoint with email "qa.mentor.8@mailinator.com", name "Mentor Eight", role "MENTOR", address "Address", phone "0815123123123", avatar "no-avatar", batch code "", university ""
    And user hit create user endpoint with email "qa.adm.3@mailinator.com", name "Admin", role "ADMIN", address "Address", phone "0815123123123", avatar "no-avatar", batch code "", university ""
  ...
  Scenario: Delete user after logging in as admin
    When user do login with email "admin@admin.com" and password "administratorfunctionapp"
    And user hit create user endpoint with email "qa.adm.4@mailinator.com", name "Admin", role "ADMIN", address "Address", phone "0815123123123", avatar "no-avatar", batch code "", university ""
    And user hit create user endpoint with email "qa.adm.5@mailinator.com", name "Admin", role "ADMIN", address "Address", phone "0815123123123", avatar "no-avatar", batch code "", university ""
