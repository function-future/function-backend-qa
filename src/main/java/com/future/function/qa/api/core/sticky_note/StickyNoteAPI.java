...
public class StickyNoteAPI extends BaseAPI {
  ...
  private Supplier<Response> createStickyNoteWithCookie(StickyNoteWebRequest request, Cookie cookie) {
  ...
  private Supplier<Response> createStickyNoteWithoutCookie(StickyNoteWebRequest request) {
